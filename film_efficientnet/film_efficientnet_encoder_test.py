...
from film_efficientnet.film_efficientnet_encoder import (
    EfficientNetB3, ILSVRCPredictor)

# If you want run this test, move to the directory above pytorch_robotics_transformer directory,
# type below command on terminal.
# python -m pytorch_robotics_transformer.film_efficientnet.film_efficientnet_encoder_test
# If you want to test all test files in film_efficientnet directory, type below command on
# terminal.
...
class FilmEfficientnetTest(parameterized.TestCase, unittest.TestCase):
    # This test method will be implemented twice. One is implemented with include_film = True.
    # Another is implemented with include_film = False.
    # To know further more, see a comment of
    ...
    def test_film_efficientnet(self, include_film):
        fe = EfficientNetB3(
            include_top=True, weights='imagenet', include_film=include_film)
        fe.eval()
